...
namespace DataFlow.Dataverse.DataModel
{
	...
	public enum Contact_AAr_VelocityCustomerStatus
	{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum Contact_AAr_VerifyMobileNumber
	{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum Contact_AAr_WillingToVerifyNewMobilePhone
	{
	...
	public enum Contact_StatusCode
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Customer", 3)]
		Customer = 745620002,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Former Customer", 5)]
		FormerCustomer = 745620004,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("General Contact", 1)]
		GeneralContact = 745620001,
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Merged Duplicate", 4)]
		MergedDuplicate = 745620003,
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity
	{
		...
		{
			public const string AAr_ActiveVerification = "aar_activeverification";
			public const string AAr_ActiveVerificationName = "aar_activeverificationname";
			public const string AAr_Address1_BuildingName = "aar_address1_buildingname";
			public const string AAr_Address1_FloorNumber = "aar_address1_floornumber";
			public const string AAr_Address1_FloorType = "aar_address1_floortype";
			public const string AAr_Address1_HouseNumber = "aar_address1_housenumber";
			public const string AAr_Address1_StreetType = "aar_address1_streettype";
			public const string AAr_Address1_UnitNumber = "aar_address1_unitnumber";
			public const string AAr_Address1StreetDirection = "aar_address1streetdirection";
			public const string AAr_Address1UnitType = "aar_address1unittype";
			public const string AAr_ComMpRefEmailCount = "aar_commprefemailcount";
			public const string AAr_ComMpRefEmailCount_Date = "aar_commprefemailcount_date";
			public const string AAr_ComMpRefEmailCount_State = "aar_commprefemailcount_state";
			public const string AAr_CommunicationSuppression = "aar_communicationsuppression";
			public const string AAr_CommunicationSuppressionName = "aar_communicationsuppressionname";
			...
			public const string AAr_CreateTempContactMobileNumber = "aar_createtempcontactmobilenumber";
			public const string AAr_CustomerBrandingNew = "aar_customerbrandingnew";
			public const string AAr_CustomerBrandIngotP = "aar_customerbrandingotp";
			public const string AAr_CustomerBrandInGoTpName = "aar_customerbrandingotpname";
			public const string AAr_CustomerSecureAnswer = "aar_customersecureanswer";
			public const string AAr_CustomerSecureQuestion = "aar_customersecurequestion";
			public const string AAr_DontEmailToPreviousEmailAddress = "aar_dontemailtopreviousemailaddress";
			public const string AAr_DontEmailToPreviousEmailAddressName = "aar_dontemailtopreviousemailaddressname";
			public const string AAr_DontSendSmsToPreviousMobile = "aar_dontsendsmstopreviousmobile";
			public const string AAr_DontSendSmsToPreviousMobileName = "aar_dontsendsmstopreviousmobilename";
			public const string AAr_EmailAddressNew = "aar_emailaddressnew";
			public const string AAr_EVCharger = "aar_evcharger";
			public const string AAr_EVChargerName = "aar_evchargername";
			...
			public const string AAr_IdVerificationStatus = "aar_idverificationstatus";
			public const string AAr_IssueWarning = "aar_issuewarning";
			public const string AAr_IssueWarningName = "aar_issuewarningname";
			...
			public const string AAr_MobileNumberNew = "aar_mobilenumbernew";
			public const string AAr_PreferredName = "aar_preferredname";
			public const string AAr_PreviousEmailAddress = "aar_previousemailaddress";
			public const string AAr_PreviousMobile = "aar_previousmobile";
			...
			public const string AAr_RegisteredForSSp = "aar_registeredforssp";
			public const string AAr_RegisteredForSsPnAMe = "aar_registeredforsspname";
			public const string AAr_SenDeMailtoPreviousEmailAddress = "aar_sendemailtopreviousemailaddress";
			public const string AAr_SenDeMailtoPreviousEmailAddressName = "aar_sendemailtopreviousemailaddressname";
			public const string AAr_SenDoTpForAcTeWAgLAccount = "aar_sendotpforactewaglaccount";
			public const string AAr_SenDoTpForAcTeWAgLAccountName = "aar_sendotpforactewaglaccountname";
			public const string AAr_SenDoTpForIconWaterAccount = "aar_sendotpforiconwateraccount";
			public const string AAr_SenDoTpForIconWaterAccountName = "aar_sendotpforiconwateraccountname";
			public const string AAr_Suffix = "aar_suffix";
			public const string AAr_SuffixName = "aar_suffixname";
			public const string AAr_SuppressUpdateNotification = "aar_suppressupdatenotification";
			public const string AAr_SuppressUpdateNotificationName = "aar_suppressupdatenotificationname";
			public const string AAr_TempContactGuid = "aar_tempcontactguid";
			public const string AAr_Title = "aar_title";
			public const string AAr_TitleName = "aar_titlename";
			public const string AAr_TransComMpRefEmail = "aar_transcommprefemail";
			public const string AAr_TransComMpRefEmail_Date = "aar_transcommprefemail_date";
			public const string AAr_TransComMpRefEmail_State = "aar_transcommprefemail_state";
			public const string AAr_VelocityCustomerId = "aar_velocitycustomerid";
			public const string AAr_VelocityCustomerStatus = "aar_velocitycustomerstatus";
			public const string AAr_VelocityCustomerStatusName = "aar_velocitycustomerstatusname";
			public const string AAr_VelocityFullName = "aar_velocityfullname";
			public const string AAr_VerificationStatus = "aar_verificationstatus";
			public const string AAr_VerifyEmailAddress = "aar_verifyemailaddress";
			public const string AAr_VerifyEmailAddressName = "aar_verifyemailaddressname";
			public const string AAr_VerifyMobileNumber = "aar_verifymobilenumber";
			public const string AAr_VerifyMobileNumberName = "aar_verifymobilenumbername";
			public const string AAr_WillingToVerifyNewEmailAddress = "aar_willingtoverifynewemailaddress";
			public const string AAr_WillingToVerifyNewEmailAddressName = "aar_willingtoverifynewemailaddressname";
			public const string AAr_WillingToVerifyNewMobilePhone = "aar_willingtoverifynewmobilephone";
			public const string AAr_WillingToVerifyNewMobilePhoneName = "aar_willingtoverifynewmobilephonename";
			...
			public const string BIm_FromPhoneNumber = "bim_fromphonenumber";
			public const string BIm_IsArchived = "bim_isarchived";
			public const string BIm_IsArchivedName = "bim_isarchivedname";
			public const string BIm_OptOut = "bim_optout";
			public const string BIm_OptOutName = "bim_optoutname";
			public const string BIm_SelectedCountry = "bim_selectedcountry";
		...
		public const string AlternateKeys = "aar_velocitycustomerid";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_activeverification")]
		public Microsoft.Xrm.Sdk.EntityReference AAr_ActiveVerification
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("aar_activeverification");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_activeverification", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_activeverificationname")]
		public string AAr_ActiveVerificationName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_activeverification"))
				{
					return this.FormattedValues["aar_activeverification"];
				}
				else
				{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1_buildingname")]
		public string AAr_Address1_BuildingName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1_buildingname");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1_buildingname", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1_floornumber")]
		public string AAr_Address1_FloorNumber
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1_floornumber");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1_floornumber", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1_floortype")]
		public string AAr_Address1_FloorType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1_floortype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1_floortype", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1_housenumber")]
		public string AAr_Address1_HouseNumber
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1_housenumber");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1_housenumber", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1_streettype")]
		public string AAr_Address1_StreetType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1_streettype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1_streettype", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1_unitnumber")]
		public string AAr_Address1_UnitNumber
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1_unitnumber");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1_unitnumber", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1streetdirection")]
		public string AAr_Address1StreetDirection
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1streetdirection");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1streetdirection", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_address1unittype")]
		public string AAr_Address1UnitType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_address1unittype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_address1unittype", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_commprefemailcount")]
		public System.Nullable<int> AAr_ComMpRefEmailCount
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("aar_commprefemailcount");
			}
		}
		
		/// <summary>
		/// Last Updated time of rollup field Comm Pref Email Count.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_commprefemailcount_date")]
		public System.Nullable<System.DateTime> AAr_ComMpRefEmailCount_Date
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("aar_commprefemailcount_date");
			}
		}
		
		/// <summary>
		/// State of rollup field Comm Pref Email Count.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_commprefemailcount_state")]
		public System.Nullable<int> AAr_ComMpRefEmailCount_State
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("aar_commprefemailcount_state");
			}
		}
		
		/// <summary>
		/// Prevent this customer from receiving marketing communications regardless of customer's preferences.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_communicationsuppression")]
		public System.Nullable<bool> AAr_CommunicationSuppression
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("aar_communicationsuppression");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_communicationsuppression", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_communicationsuppressionname")]
		public string AAr_CommunicationSuppressionName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_communicationsuppression"))
				{
					return this.FormattedValues["aar_communicationsuppression"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Trigger to create temporary contact record creation for SMS OTP
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_createtempcontactmobilenumber")]
		public string AAr_CreateTempContactMobileNumber
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_createtempcontactmobilenumber");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_createtempcontactmobilenumber", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_customerbrandingnew")]
		public string AAr_CustomerBrandingNew
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_customerbrandingnew");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_customerbrandingnew", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_customerbrandingotp")]
		public virtual AAr_SmsBranding? AAr_CustomerBrandIngotP
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((AAr_SmsBranding?)(EntityOptionSetEnum.GetEnum(this, "aar_customerbrandingotp")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_customerbrandingotp", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_customerbrandingotpname")]
		public string AAr_CustomerBrandInGoTpName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_customerbrandingotp"))
				{
					return this.FormattedValues["aar_customerbrandingotp"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Set a secure PIN for the customer which is a minimum of 4 digits and a maximum of 8
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_customersecureanswer")]
		public string AAr_CustomerSecureAnswer
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_customersecureanswer");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_customersecureanswer", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_customersecurequestion")]
		public string AAr_CustomerSecureQuestion
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_customersecurequestion");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_customersecurequestion", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_dontemailtopreviousemailaddress")]
		public virtual MSeVTmGt_YesOrNo? AAr_DontEmailToPreviousEmailAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((MSeVTmGt_YesOrNo?)(EntityOptionSetEnum.GetEnum(this, "aar_dontemailtopreviousemailaddress")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_dontemailtopreviousemailaddress", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_dontemailtopreviousemailaddressname")]
		public string AAr_DontEmailToPreviousEmailAddressName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_dontemailtopreviousemailaddress"))
				{
					return this.FormattedValues["aar_dontemailtopreviousemailaddress"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_dontsendsmstopreviousmobile")]
		public virtual MSeVTmGt_NoOrYes? AAr_DontSendSmsToPreviousMobile
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((MSeVTmGt_NoOrYes?)(EntityOptionSetEnum.GetEnum(this, "aar_dontsendsmstopreviousmobile")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_dontsendsmstopreviousmobile", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_dontsendsmstopreviousmobilename")]
		public string AAr_DontSendSmsToPreviousMobileName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_dontsendsmstopreviousmobile"))
				{
					return this.FormattedValues["aar_dontsendsmstopreviousmobile"];
				}
				else
				{
					return default(string);
		...
		/// Email Address (New)
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_emailaddressnew")]
		public string AAr_EmailAddressNew
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_emailaddressnew");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_emailaddressnew", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_evcharger")]
		public Microsoft.Xrm.Sdk.EntityReference AAr_EVCharger
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("aar_evcharger");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_evcharger", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_evchargername")]
		public string AAr_EVChargerName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_evcharger"))
				{
					return this.FormattedValues["aar_evcharger"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_idverificationstatus")]
		public string AAr_IdVerificationStatus
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_idverificationstatus");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_issuewarning")]
		public System.Nullable<bool> AAr_IssueWarning
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("aar_issuewarning");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_issuewarningname")]
		public string AAr_IssueWarningName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_issuewarning"))
				{
					return this.FormattedValues["aar_issuewarning"];
				}
				else
				{
					return default(string);
		...
		public System.Nullable<bool> AAr_LifeSupportRequired
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("aar_lifesupportrequired");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_lifesupportrequired", value);
			}
		}
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_mobilenumbernew")]
		public string AAr_MobileNumberNew
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_mobilenumbernew");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_mobilenumbernew", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_preferredname")]
		public string AAr_PreferredName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_preferredname");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_preferredname", value);
			}
		}
		...
		/// Email address
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_previousemailaddress")]
		public string AAr_PreviousEmailAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_previousemailaddress");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_previousemailaddress", value);
			}
		}
		
		/// <summary>
		/// Displays the previous Mobile Number for the record.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_previousmobile")]
		public string AAr_PreviousMobile
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_previousmobile");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_previousmobile", value);
			}
		}
		...
		/// <summary>
		/// Is customer registered for SSP?
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_registeredforssp")]
		public System.Nullable<bool> AAr_RegisteredForSSp
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("aar_registeredforssp");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_registeredforssp", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_registeredforsspname")]
		public string AAr_RegisteredForSsPnAMe
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_registeredforssp"))
				{
					return this.FormattedValues["aar_registeredforssp"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_sendemailtopreviousemailaddress")]
		public virtual AAr_SendEmail? AAr_SenDeMailtoPreviousEmailAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((AAr_SendEmail?)(EntityOptionSetEnum.GetEnum(this, "aar_sendemailtopreviousemailaddress")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_sendemailtopreviousemailaddress", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_sendemailtopreviousemailaddressname")]
		public string AAr_SenDeMailtoPreviousEmailAddressName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_sendemailtopreviousemailaddress"))
				{
					return this.FormattedValues["aar_sendemailtopreviousemailaddress"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Used to send OTP from ActewAGL account and  trigger cloud flows to send OTP
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_sendotpforactewaglaccount")]
		public System.Nullable<bool> AAr_SenDoTpForAcTeWAgLAccount
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("aar_sendotpforactewaglaccount");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_sendotpforactewaglaccount", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_sendotpforactewaglaccountname")]
		public string AAr_SenDoTpForAcTeWAgLAccountName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_sendotpforactewaglaccount"))
				{
					return this.FormattedValues["aar_sendotpforactewaglaccount"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Used to send OTP from Icon Water account and  trigger cloud flows to send OTP
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_sendotpforiconwateraccount")]
		public System.Nullable<bool> AAr_SenDoTpForIconWaterAccount
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("aar_sendotpforiconwateraccount");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_sendotpforiconwateraccount", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_sendotpforiconwateraccountname")]
		public string AAr_SenDoTpForIconWaterAccountName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_sendotpforiconwateraccount"))
				{
					return this.FormattedValues["aar_sendotpforiconwateraccount"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_suffix")]
		public Microsoft.Xrm.Sdk.EntityReference AAr_Suffix
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("aar_suffix");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_suffix", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_suffixname")]
		public string AAr_SuffixName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_suffix"))
				{
					return this.FormattedValues["aar_suffix"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_suppressupdatenotification")]
		public System.Nullable<bool> AAr_SuppressUpdateNotification
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("aar_suppressupdatenotification");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_suppressupdatenotification", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_suppressupdatenotificationname")]
		public string AAr_SuppressUpdateNotificationName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_suppressupdatenotification"))
				{
					return this.FormattedValues["aar_suppressupdatenotification"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Temp contact to send OTP for mobile number update
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_tempcontactguid")]
		public string AAr_TempContactGuid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_tempcontactguid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_tempcontactguid", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_title")]
		public Microsoft.Xrm.Sdk.EntityReference AAr_Title
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("aar_title");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_title", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_titlename")]
		public string AAr_TitleName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_title"))
				{
					return this.FormattedValues["aar_title"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_transcommprefemail")]
		public System.Nullable<int> AAr_TransComMpRefEmail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("aar_transcommprefemail");
			}
		}
		
		/// <summary>
		/// Last Updated time of rollup field Trans Comm Pref Email.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_transcommprefemail_date")]
		public System.Nullable<System.DateTime> AAr_TransComMpRefEmail_Date
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("aar_transcommprefemail_date");
			}
		}
		
		/// <summary>
		/// State of rollup field Trans Comm Pref Email.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_transcommprefemail_state")]
		public System.Nullable<int> AAr_TransComMpRefEmail_State
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("aar_transcommprefemail_state");
			}
		}
		
		/// <summary>
		/// Primary Customer Id in Velocity
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_velocitycustomerid")]
		public string AAr_VelocityCustomerId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_velocitycustomerid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_velocitycustomerid", value);
			}
		}
		
		/// <summary>
		/// Velocity status field from the Customer table.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_velocitycustomerstatus")]
		public virtual Contact_AAr_VelocityCustomerStatus? AAr_VelocityCustomerStatus
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((Contact_AAr_VelocityCustomerStatus?)(EntityOptionSetEnum.GetEnum(this, "aar_velocitycustomerstatus")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_velocitycustomerstatus", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_velocitycustomerstatusname")]
		public string AAr_VelocityCustomerStatusName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_velocitycustomerstatus"))
				{
					return this.FormattedValues["aar_velocitycustomerstatus"];
				}
				else
				{
					return default(string);
		...
		/// Customer full name
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_velocityfullname")]
		public string AAr_VelocityFullName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_velocityfullname");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_velocityfullname", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_verificationstatus")]
		public string AAr_VerificationStatus
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("aar_verificationstatus");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_verificationstatus", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_verifyemailaddress")]
		public virtual AAr_YesNo? AAr_VerifyEmailAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((AAr_YesNo?)(EntityOptionSetEnum.GetEnum(this, "aar_verifyemailaddress")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_verifyemailaddress", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_verifyemailaddressname")]
		public string AAr_VerifyEmailAddressName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_verifyemailaddress"))
				{
					return this.FormattedValues["aar_verifyemailaddress"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_verifymobilenumber")]
		public virtual Contact_AAr_VerifyMobileNumber? AAr_VerifyMobileNumber
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((Contact_AAr_VerifyMobileNumber?)(EntityOptionSetEnum.GetEnum(this, "aar_verifymobilenumber")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_verifymobilenumber", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_verifymobilenumbername")]
		public string AAr_VerifyMobileNumberName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_verifymobilenumber"))
				{
					return this.FormattedValues["aar_verifymobilenumber"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_willingtoverifynewemailaddress")]
		public virtual AAr_YesNo? AAr_WillingToVerifyNewEmailAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((AAr_YesNo?)(EntityOptionSetEnum.GetEnum(this, "aar_willingtoverifynewemailaddress")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_willingtoverifynewemailaddress", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_willingtoverifynewemailaddressname")]
		public string AAr_WillingToVerifyNewEmailAddressName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_willingtoverifynewemailaddress"))
				{
					return this.FormattedValues["aar_willingtoverifynewemailaddress"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Option to send OTP to the new Number.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_willingtoverifynewmobilephone")]
		public virtual Contact_AAr_WillingToVerifyNewMobilePhone? AAr_WillingToVerifyNewMobilePhone
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((Contact_AAr_WillingToVerifyNewMobilePhone?)(EntityOptionSetEnum.GetEnum(this, "aar_willingtoverifynewmobilephone")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("aar_willingtoverifynewmobilephone", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("aar_willingtoverifynewmobilephonename")]
		public string AAr_WillingToVerifyNewMobilePhoneName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("aar_willingtoverifynewmobilephone"))
				{
					return this.FormattedValues["aar_willingtoverifynewmobilephone"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bim_fromphonenumber")]
		public string BIm_FromPhoneNumber
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("bim_fromphonenumber");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("bim_fromphonenumber", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bim_isarchived")]
		public System.Nullable<bool> BIm_IsArchived
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("bim_isarchived");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("bim_isarchived", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bim_isarchivedname")]
		public string BIm_IsArchivedName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("bim_isarchived"))
				{
					return this.FormattedValues["bim_isarchived"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bim_optout")]
		public System.Nullable<bool> BIm_OptOut
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("bim_optout");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("bim_optout", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bim_optoutname")]
		public string BIm_OptOutName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("bim_optout"))
				{
					return this.FormattedValues["bim_optout"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bim_selectedcountry")]
		public string BIm_SelectedCountry
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("bim_selectedcountry");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("bim_selectedcountry", value);
			}
		}
		...
		/// <summary>
		/// The email address that has been verified using an OTP code.
		/// </summary>
		...
		/// <summary>
		/// 1:N aar_contact_aar_customerroles_257
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("aar_contact_aar_customerroles_257")]
		public System.Collections.Generic.IEnumerable<DataFlow.Dataverse.DataModel.AAr_CustomerRoles> AAr_Contact_AAr_CustomerRoles_257
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataFlow.Dataverse.DataModel.AAr_CustomerRoles>("aar_contact_aar_customerroles_257", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataFlow.Dataverse.DataModel.AAr_CustomerRoles>("aar_contact_aar_customerroles_257", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DataFlow.Dataverse.DataModel.Contact> ReferencedContact_Customer_Contacts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DataFlow.Dataverse.DataModel.Contact> ReferencedContact_Master_Contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DataFlow.Dataverse.DataModel.Contact> ReferencedContact_Parent_Contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DataFlow.Dataverse.DataModel.Contact> ReferencedMsGdPr_Contact_MsGdPr_GdPrParent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("msgdpr_contact_msgdpr_gdprparent", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataFlow.Dataverse.DataModel.Contact>("msgdpr_contact_msgdpr_gdprparent", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public DataFlow.Dataverse.DataModel.Contact ReferencingContact_Customer_Contacts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataFlow.Dataverse.DataModel.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataFlow.Dataverse.DataModel.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public DataFlow.Dataverse.DataModel.Contact ReferencingContact_Master_Contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataFlow.Dataverse.DataModel.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public DataFlow.Dataverse.DataModel.Contact ReferencingContact_Parent_Contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataFlow.Dataverse.DataModel.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataFlow.Dataverse.DataModel.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public DataFlow.Dataverse.DataModel.Contact ReferencingMsGdPr_Contact_MsGdPr_GdPrParent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataFlow.Dataverse.DataModel.Contact>("msgdpr_contact_msgdpr_gdprparent", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataFlow.Dataverse.DataModel.Contact>("msgdpr_contact_msgdpr_gdprparent", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
