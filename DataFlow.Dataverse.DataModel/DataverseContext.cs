...
namespace DataFlow.Dataverse.DataModel
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataFlow.Dataverse.DataModel.AAr_Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataFlow.Dataverse.DataModel.AAr_Account> AAr_AccountSet
		{
			get
			{
				return this.CreateQuery<DataFlow.Dataverse.DataModel.AAr_Account>();
			}
		}
		...
		public System.Linq.IQueryable<DataFlow.Dataverse.DataModel.AAr_CustomerRoles> AAr_CustomerRolesSet
		{
			get
			{
				return this.CreateQuery<DataFlow.Dataverse.DataModel.AAr_CustomerRoles>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataFlow.Dataverse.DataModel.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataFlow.Dataverse.DataModel.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<DataFlow.Dataverse.DataModel.Contact>();
			}
		}
	}
